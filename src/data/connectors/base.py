...
class DataConnector(ABC):
    ...
    @abstractmethod
    def get_financial_metrics(self, ticker: str, start_date: str = None, end_date: str = None, limit: int = 10) -> List[FinancialMetrics]:
        """Get financial metrics for a ticker."""
        pass

    @abstractmethod
    def search_line_items(self, ticker: str, query: str = None, limit: int = 10) -> List[LineItem]:
        """Search line items for a ticker."""
        pass

    @abstractmethod
    def get_insider_trades(self, ticker: str, start_date: str = None, end_date: str = None, limit: int = 1000) -> List[InsiderTrade]:
        """Get insider trades for a ticker."""
        pass

    @abstractmethod
    def get_company_news(self, ticker: str, start_date: str = None, end_date: str = None, limit: int = 1000) -> List[CompanyNews]:
